...
void QSPIMakeCommandList() {
	...
	qspi_cmds[0x5A] = CommandAttr { true,true,true,false,0x01,0x02,"Read SFDP" };
	qspi_cmds[0x03] = CommandAttr { true,false,true,false,0x01,0x02,"Read" };
	qspi_cmds[0xC0] = CommandAttr { true,false,true,true,0x01,0x01,"Setup Read Wrap" };
	qspi_cmds[0x0B] = CommandAttr { true,true,true,false,0x01,0x02,"Fast Read" };
	qspi_cmds[0x0C] = CommandAttr { true,true,true,false,0x01,0x02,"Fast Read Wrapped" };
	...
	qspi_cmds[0x71] = CommandAttr { false,false,true,false,0x00,0x02,"Read Vol Cfg Reg" };
	...
	qspi_cmds[0x20] = CommandAttr { true,false,false,false,0x01,0x00,"Subsector Erase (4K)" };
	qspi_cmds[0x21] = CommandAttr { true,false,false,false,0x01,0x00,"Subsector Erase (4K)" };
	qspi_cmds[0x52] = CommandAttr { true,false,false,false,0x01,0x00,"Subsector Erase (32K)" };
	qspi_cmds[0x53] = CommandAttr { true,false,false,false,0x01,0x00,"Subsector Erase (32K)" };
	qspi_cmds[0xD8] = CommandAttr { true,false,false,false,0x01,0x00,"Sector Erase" };
	qspi_cmds[0xDC] = CommandAttr { true,false,false,false,0x01,0x00,"Sector Erase" };
	...
	qspi_cmds[0x30] = CommandAttr { false,false,false,false,0x00,0x00,"Pgm/Erase Resume" };
	qspi_cmds[0xD0] = CommandAttr { false,false,false,false,0x00,0x00,"Pgm/Erase Resume" };
	qspi_cmds[0x75] = CommandAttr { false,false,false,false,0x00,0x00,"Pgm/Erase Suspend" };
	qspi_cmds[0xB0] = CommandAttr { false,false,false,false,0x00,0x00,"Pgm/Erase Suspend" };
